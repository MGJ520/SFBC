...
//
//
//BLDCDriver3PWM driver_A = BLDCDriver3PWM(42, 41, 40); // 电机A的驱动器
//BLDCDriver3PWM driver_B = BLDCDriver3PWM(17, 16, 15); // 电机B的驱动器
//
//
//// 用于检测电机电流，参数分别为：电阻值、增益、电流检测引脚、电压检测引脚、备用引脚
//LowsideCurrentSense cs_A = LowsideCurrentSense(0.005f, 50.0f, 10, 9, _NC); // 电机A的电流检测
...
//
//    //I2C
//    I2C_A.begin(13, 14, 400000UL);
//    I2C_B.begin(7, 6, 400000UL);
//
//    //MPU初始化
//    mpu6050.begin();
//
